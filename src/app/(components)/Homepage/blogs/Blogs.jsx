        ...
        <Slider {...settings}>
          {
            ...
            <div className="relative z-20 max-w-lg py-4 px-3 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900 outline-none focus:outline-none">
          ...
          {/* <div className="px-4 outline-none focus:outline-none">
            ...
            <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900 outline-none focus:outline-none">
              <a href="#" className="font-semibold text-lg text-gray-800 hover:underline dark:text-white md:text-md outline-none focus:outline-none">
